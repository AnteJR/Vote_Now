...
let scenarios = [                                        // scenarios stores all useful data for each votation you can play
    [                                                    // scenarios is structured as follos:
        ...
        0.8,                                                // 14. the exact date the vote took place
        "20.02.1898",                                       // 15-16. texts explaining what happens depending if the player wins or fails
        "The bill is accepted! Thanks to your efforts, the CFF are created and operated by the Confederation. This means cheaper, more efficient, and uniform railways throughout the country. In 1898, the project had cumulated 67.9% of all the votes.",
        "The bill is rejected by the population. The Confederation is thus not allowed to buy the Central Swiss Railways to manage them at the state level. Without the creation of the CFF, railways stay in private hands, for better or for worse. This is not the first time the government is blocked by vote for that specific buyout: it was already rejected in 1891 by 68.9% of the population!",
    ...
    [
        ...
        "The bill failed; the opposing parties were more aggressive than you. The insurance won't be available to anyone except the richer portion of the population. Indeed, public spending bills for the needy and insurances laws always are difficult to pass in Switzerland...",
    ...
    [
        ...
        "The bill is rejected. As of yet, there is still to be a fund for disabled people, veterans and the elderly. Outside of charity, that is, though this will hardly allows people affected to get by. And maybe most disheartening of all: this is already the second time the population voted no on this matter.",
    ...
    [
        ...
        "Unsurprisingly, the bill failed. The Swiss people are too proud to the army to vote against it. Though there would be plenty of reasons why a mandatory military service would be frowned upon, it is not the case in Switzerland, at least for now. The initiative failed, as it did in real life.",
