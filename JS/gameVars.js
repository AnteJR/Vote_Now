...
let scenarios = {   // scenarios stores all useful data for each votation you can play
    ...
    french: [
        ...
        [
            ...
            "Nouvelle Protection Civile (1959)\n\nLes deux Guerres mondiales et les menaces nucleaires font peur a la Suisse.\n\nAussi le gouvernement pense a creer une nouvelle milice parrallele a l'armee pour assurer le maintien et contrôle des abris nucleaires, ainsi qu'aider la population en cas de catasrophe naturelle, sanitaire ou sociale...",
            62.3,
            true
        ],
        [
