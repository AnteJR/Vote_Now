...
let scenarios = [                                        // scenarios stores all useful data for each votation you can play
    ...
    [
        ...
        35, 1000, 0.9,
        "07.02.1971",
        "La loi est ENFIN passée!\n\nIt's been since 1959; it took many convincing in the most rural cantons, and a lot of patience. But Switzerland finally joins the rest of Europe by allowing women to vote. The real vote saw 65.7% of ballots in favor of women's suffrage.",
        "La loi est rejetée...\n\nSwitzerland is not at its first attempt to implement women's suffrage, and this one isn't its last. For 12 years now the male population refuses to give women the right to vote. Alas, Switzerland is set to be the last western country to get there. Quite the achievement...",
        "Women's suffrage (1971)\n\nFirst tried and rejected by the population in 1959, women's suffrage isn't finding a place in Switzerland. Now that almost all European countries have adopted it, the federal government insists on pushing this bill to give women the right to vote. They hope the international context might push the nay-sayers in the right direction this time...",
        65.7,
        true
    ],
    [
        ...
        25, 500, 0.7,
        "26.11.1989",
        "La loi est passée???\n\nThat's quite the achievement. In reality, the vote failed with only 35.6% of ballots in favor of the revocation of mandatory military service for men. It is a sticking tradition of which the Swiss people are proud of, and which rarely, if even changes. But it changed. And from now on men won't be required to serve in the military!",
        "La loi est rejetée.\n\nThe Swiss people are too proud to their army to vote against it. The initiative failed, as it did in real life with only 35.6% of votes.",
        "Initiative against mandatory military service (1989)\n\nWar are never fun, and the fact that Switzerland has a mandatory military service doesn't please the GSSA (Groupe pour une Suisse sans armee; Group for a military-free Switzerland). This year, they got enough signature to try and ban the practice in Switzerland. La loi a échoué en réalité, mais peut-être que vous parviendrez à réaliser l'impossible...!",
        35.6,
        true
    ],
    [
        ...
        20, 1000, 0.85,
        "23.09.1990",
        "La loi est passée!\n\nThis is a resounding victory for environmentalists! Now, Switzerland will try to have greener ways of producing energy. The bill did pass for real, garnering 54.5% of the votes!",
        "La loi est rejetée.\n\nIn reality the bill did not fail, but here, this means Switzerland can still create new centrals to keep its energy independance. Much to the detriment of environmentalists, the Swiss nuclear energy is safe and sound, for now.",
        "Get out of nuclear initiative (1990)\n\nFollowing events such as Chernobyl, nuclear energy got an ever worsening reputation as an unsafe way to generate power. As such, this bill forcing the government to stop producing new nuclear centrals and start to transition its energy production seems like an appropriate reponse to a fear that the population has.",
        54.5,
        true
    ],
    [
        ...
        29, 2000, 0.65,
        "03.03.2002",
        "La loi est passée!\n\nThis is a victory for international community building! Now, Switzerland will collaborate more closely with the UN, have a siege there, and will be able to vote for the UN's decisions. The bill did pass in our world, garnering 54.6% of the votes!",
        "La loi est rejetée.\n\nSwitzerland won't be joining the UN for a few years at least. It will still act as a neutral ground for the UN to meet and deliberate, but won't take part in the debates, nor the decision process. Such is the price of political neutraliy, say the ones who were opposed to this adhesion.",
        "Initiative for Switzerland to join the UN (2002)\n\nIt's been years in the making, and the people will finally vote on it: Switzerland may join the UN if the vote passes! International collaboration is important, and Switzerland already has a central role in the UN's infrastructure (the UN Office is in Geneva). Thus, why not join, for good?",
        54.6,
        true
    ],
    [
        ...
        16, 1000, 0.8,
        "11.03.2012",
        "La loi est passée!\n\nWith that, constructing a new secondary residence, espcially in the more rural parts of the country, will be much more complicated: either you live there, or don't construct anything. The bill did pass by a hair for real, garnering a mere 50.6% of the votes!",
        "La loi est rejetée.\n\nfor now, legislation on construction in the countryside won't change, and there won't be restrictions put in place if you want to build a secondary place of residence in Switzerland. This is to the detriment of the local population and the Swiss landscape, but investors and construction companies can keep making money.",
        "Initiative to prevent new secondary homes (2012)\n\nMany rich Swiss residents, as well as wealthy foreigners, take advantage of Switzerland's relatively lax laws to build secondary residence in the most beautiful parts of the country, even if they come there only 2 weeks every year. This initiative wants to change that, and prevent new secondary homes to be built in the countryside.",
        50.6,
        true
    ...
    [
        ...
        25, 1500, 0.91,
        "09.02.2020",
        "La loi est passée!\n\nSame-sex couples and people experience same-sex attraction will now be protected under the law against discrimination of all kinds. This is a important step towards a more equal society, and a clear victory for progressives. The law also passed in reality, with 63.1% of votes in favor.",
        "La loi est rejetée.\n\nthis is a clear disappointment for the people who spent time organizing and planning the campaign. For now, homosexual individuals won't be protected from discrimination, which unfortunately keeps them more vulnerable to homophobia.",
        "Stop discrimination based on sexual orientation bill (2020)\n\nSwitzerland protects people against racial prejudice, whether someone discriminates or incites to racial hatred. This law proposes to do the same for people experiencing same-sex attraction. A step in the right direction for Switzerland in 2020. Now to see what the people thinks.",
        63.1,
        true
    ],
    [
        ...
        27, 2000, 0.8,
        "26.09.2021",
        "La loi est passée!\n\nSame-sex couples will now be able to marry with the same legal status as heterosexual couples; this also gives them access to adoption and artificial insemination, which allows them to have children, and for those children to be recognized under the law. This is a resounding victory for progress, and one which garnered 64.1% of positive votes in our reality.",
        "La loi est rejetée.\n\nthis is heart-breaking. Same-sex couples will not be able to marry, nor adopt or have children recognized, like is the case for heterosexual couples. Because this referendum was victorious and the law failed, the government won't be able to make a new law for same-sex couples for at least 5 years to a decade! This really is a shame...",
        "Same-sex marriage and adoption (2021)\n\nSwitzerland still doesn't allow for same-sex couple to marry and have children. Currently, a union is possible, but really only helps for succession rights. This bill not only proposes to make marriage fully legal for same-sex couples, but also allows them to have children, and for those children to be recognized under the law.",
        64.1,
        true
    ],
    [
        ...
        "25.09.2022",
        "La loi est passée!\n\nThis is a victory! It means women can still retire at 64 without reprecussion on their retirement fund. This also means there won't be a flexible limit to retirement to incetivize people to retire at 70. This is a social victory for the Swiss people, which unfortunately passed in our reality with a measly 50.5% of the votes.",
        "La loi est rejetée.\n\nthis is a clear step backwards. Now, women will have to retire at 65, and there will an incentivization for poorer people to work for up to 70 years old. The bill also passed for real, with a mere 50.5% favorable votes, which is frustrating to say the least.",
        "Elderly's insurance reform (2022)\n\nDespite record profits, the government fears there may not be enough to provide for all the elderly in the near future. The solution? Increase women's retirement age from 64 to 65, and implement a system where the later you retire (up to 70), the better you fund will be, incentivizing people to retire later.",
        50.5,
        false
    ]]
