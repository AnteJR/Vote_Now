...
let scenarios = [                                        // scenarios stores all useful data for each votation you can play
    ...
    [
        ...
        "The bill passed; this is a clear step backwards. Now, women will have to retire at 65, and there will be a flexible retirement age, incentivizing poorer populations to work for up to 70 years old. This will likely prove a loss for the working-class. The bill also passed in our reality, with only 50.5% of the votes, which is frustrating to say the least.",
