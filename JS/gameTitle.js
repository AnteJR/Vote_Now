...
scene("creditsPage", () => {
    let creditsTxt = {
        ...
        french: `Un jeu cree, ecrit, designe et developpe par Joël Rimaz\n\nSous la supervision d'Isaac Pante\n\nAout 2022`
    }, langSprites = {
        english: "_ENG",
        french: "_FR"
    };
...
scene("errorLocalStorage", () => {
    let errorMsg = {
        ...
        french: "Vote Now a besoin du stockage local de votre navigateur pour fonctionner. Pour des raisons hors de mon controle, votre navigateur ne lui donne pas acces a ce stockage.\n\nPour resoudre ce probleme, essayez un navigateur different. Firefox devrait fonctionner sans probleme. Navre de la gene occasionnee."
    }
